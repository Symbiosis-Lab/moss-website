...
<main role="main">
    <section class="gallery" role="img" aria-label="Photography collection">
        ...
        <div class="gallery-grid">
            <figure role="img">
                <img src="photo.webp" alt="Detailed description" 
...
<picture>
    ...
    <source media="(min-width: 768px)"
            ...
            sizes="(min-width: 1200px) 1200px, 100vw">
    <source srcset="small.webp 800w, small@2x.webp 1600w"
            sizes="100vw"
            type="image/webp">
    <img src="small.jpg" 
...
function updateReadingProgress() {
    ...
    const scrollProgress = window.scrollY / (article.offsetHeight - window.innerHeight);
...
*Research compiled August 2025 from verified sources on platform usage, user feedback, design best practices, and cognitive load research.*